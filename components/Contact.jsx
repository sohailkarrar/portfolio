...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Then send using Web3Forms as a backup
      await handleWeb3Forms();
  ...
  const handleWeb3Forms = async () => {
    const formData = new FormData();
    formData.append("access_key", "210255f8-85d9-4e21-904d-02991cb4614e");
    formData.append("name", DOMPurify.sanitize(form.name));
    formData.append("email", DOMPurify.sanitize(form.email));
    formData.append("message", DOMPurify.sanitize(form.message));
